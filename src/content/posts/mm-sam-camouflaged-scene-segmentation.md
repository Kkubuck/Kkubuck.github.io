...
description: BLIP text·visual embedding, multi-level adapter, SAM dense embedding 교체를 통해 prompt-free multimodal
  COD를 구현하고 다른 segmentation task로도 확장한다.
summary: BLIP text·visual embedding, multi-level adapter, SAM dense embedding 교체를 통해 prompt-free multimodal COD를
  구현하고 다른 segmentation task로도 확장한다.
subtitle: 수동 prompt 대신 BLIP이 만든 caption의 text embedding과 image embedding을 SAM에 주입해, 장면 의미를 먼저 이해한 뒤 위장 객체 마스크를 생성하는
  Vision-Language-SAM.
...
categories:
- papers
sourceUrl: https://openaccess.thecvf.com/content/ICCV2025/html/Ren_Multi-modal_Segment_Anything_Model_for_Camouflaged_Scene_Segmentation_ICCV_2025_paper.html
venue: ICCV 2025
paperYear: 2025
authors: Guangyu Ren, Hengyan Liu, Michalis Lazarou, Tania Stathaki
reviewedOn: '2026-07-10'
pdfUrl: https://openaccess.thecvf.com/content/ICCV2025/papers/Ren_Multi-modal_Segment_Anything_Model_for_Camouflaged_Scene_Segmentation_ICCV_2025_paper.pdf
codeUrl: https://github.com/ic-qialanqian/Vision-Language-SAM
takeaways:
