...
summary: TSP-SAM은 motion-driven self-prompt와 long-range consistency를 결합한다. temporal cue를 prompt 생성과 SAM encoder adaptation
  양쪽에 사용한다.
description: TSP-SAM은 motion-driven self-prompt와 long-range consistency를 결합한다. temporal cue를 prompt 생성과 SAM encoder adaptation
  양쪽에 사용한다.
...
venue: CVPR 2024
paper_year: 2024
paper_authors: Wenjun Hui, Zhenfeng Zhu, Shuai Zheng, Yao Zhao
