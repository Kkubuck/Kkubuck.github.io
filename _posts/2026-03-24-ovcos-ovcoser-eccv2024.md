...
| 벤치마크 | 핵심 포인트 |
| --- | --- |
| OVCamo | 11,483장 규모의 open-vocabulary camouflaged object segmentation benchmark로, novel class generalization과 위장 장면 인식을 함께 본다. |
| 기존 OVSIS baselines | OVCoser는 OVCamo에서 이전 open-vocabulary segmentation 방법을 큰 폭으로 앞선다고 보고한다. |
