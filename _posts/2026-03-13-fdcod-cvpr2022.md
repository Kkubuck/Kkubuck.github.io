...
summary: FDCOD은 DCT 기반 Frequency Enhancement Module, RGB–frequency feature alignment, High-Order Relation Module을 결합해 공간 영역
  밖의 단서를 적극적으로 사용한다.
description: FDCOD은 DCT 기반 Frequency Enhancement Module, RGB–frequency feature alignment, High-Order Relation Module을 결합해
  공간 영역 밖의 단서를 적극적으로 사용한다.
...
venue: CVPR 2022
paper_year: 2022
paper_authors: Yijie Zhong, Bo Li, Lv Tang, Senyun Kuang, Shuang Wu, Shouhong Ding
...
code_url: https://github.com/luckybird1994/FDCOD
takeaways:
