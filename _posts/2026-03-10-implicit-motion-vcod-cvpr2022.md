...
summary: 인접 프레임의 dense correlation volume으로 단기 움직임을 포착하고 spatio-temporal transformer로 장기 일관성을 보강한다. MoCA-Mask 데이터셋도 함께 제안한다.
description: 인접 프레임의 dense correlation volume으로 단기 움직임을 포착하고 spatio-temporal transformer로 장기 일관성을 보강한다. MoCA-Mask 데이터셋도 함께
  제안한다.
...
venue: CVPR 2022
paper_year: 2022
paper_authors: Xuelian Cheng, Huan Xiong, Deng-Ping Fan, Yiran Zhong, Mehrtash Harandi, Tom Drummond, Zongyuan Ge
...
code_url: https://xueliancheng.github.io/SLT-Net-project
takeaways:
