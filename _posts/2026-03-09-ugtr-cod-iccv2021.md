...
summary: UGTR은 backbone 출력의 조건부 분포에서 초기 예측과 uncertainty를 얻고, 불확실한 영역을 attention으로 재추론한다. Bayesian representation과 transformer를
  결합한 초기 COD 연구다.
description: UGTR은 backbone 출력의 조건부 분포에서 초기 예측과 uncertainty를 얻고, 불확실한 영역을 attention으로 재추론한다. Bayesian representation과 transformer를
  결합한 초기 COD 연구다.
...
venue: ICCV 2021
paper_year: 2021
paper_authors: Fan Yang, Qiang Zhai, Xin Li, Rui Huang, Ao Luo, Hong Cheng, Deng-Ping Fan
...
code_url: https://github.com/fanyang587/UGTR
takeaways:
