...
| 벤치마크 | 핵심 포인트 |
| --- | --- |
| 20% fully labeled setting | 상당히 제한된 fully labeled data만으로도 기존 weakly/semi-supervised COD 방법보다 더 강한 성능을 보고한다. |
| 주류 COD benchmarks | 세 개의 mainstream COD benchmarks에서 annotation budget 대비 효율이 좋다는 점을 강조한다. |
