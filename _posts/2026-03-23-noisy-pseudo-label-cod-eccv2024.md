...
subtitle: 소수의 정밀 마스크와 box prompt로 만든 거친 pseudo label을 함께 쓰되, 학습 초반의 깨끗한 패턴과 후반의 noise memorization을 구분해 gradient를 교정하는 weakly
  semi-supervised COD.
summary: 제한된 fully labeled data와 box-prompt pseudo labels를 결합하고, noise correction loss가 학습 단계에 따라 올바른 픽셀을 우선 학습하고 noisy gradient를
  수정한다.
description: 제한된 fully labeled data와 box-prompt pseudo labels를 결합하고, noise correction loss가 학습 단계에 따라 올바른 픽셀을 우선 학습하고 noisy
  gradient를 수정한다.
...
venue: ECCV 2024
paper_year: 2024
paper_authors: Jin Zhang, Ruiheng Zhang, Yanjiao Shi, Zhe Cao, Nian Liu, Fahad Shahbaz Khan
reviewed_on: '2026-07-10'
source_url: https://eccv.ecva.net/virtual/2024/poster/2275
pdf_url: https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/02275.pdf
takeaways:
